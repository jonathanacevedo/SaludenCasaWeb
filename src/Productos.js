...
import CuadroProductos from './Componentes/CuadroProductos';
import CartTable from './Componentes/cartTable/'; 
...
export default connect(mapStateToPros, mapDispatchToProps)(Productos);
